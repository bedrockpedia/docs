...
description: Common issues and solutions for PowerNukkitX server problems.
---
...
**Solution**:
- PowerNukkitX requires **Java 21** or later
...
**Solution**:
- Delete `pnx.yml` and `server.properties`
...
2. **Check firewall**: Allow Java/PowerNukkitX through Windows Firewall
...
- Verify plugin compatibility with your PowerNukkitX version
...
<Blockquote color="primary">
  Join the PowerNukkitX community for support:
