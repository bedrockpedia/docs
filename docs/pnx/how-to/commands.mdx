---
title: Commands
description: Essential commands for managing your PowerNukkitX server.
---

# Commands

Master the essential commands needed to manage your PowerNukkitX server effectively.
