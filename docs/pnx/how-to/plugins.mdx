---
title: Plugins
description: Learn how to install and manage plugins on your PowerNukkitX server.
---
...
- **PowerNukkitX Bundle**: [github.com/PowerNukkitX-Bundle](https://github.com/PowerNukkitX-Bundle)
