---
title: Updating
description: Keep your Nukkit server up to date with the latest features and fixes.
---
...
### Check Compatibility
Visit the [Nukkit Articles](https://cloudburstmc.org/articles/) page and check:
- New features
- Breaking changes
...
Download the newest `nukkit-1.0-SNAPSHOT.jar` from [dl.opencollab.dev](https://dl.opencollab.dev/nukkit).
