---
title: Commands
description: Essential commands for managing your PocketMine-MP server.
---

# Commands

Master the essential commands needed to manage your PocketMine-MP server effectively.
...
| `whitelist reload` | Reloads the whitelist from the file |
